      ...
      <Bootnav.Collapse id="responsive-navbar-nav">
        ...
        <Nav className="mr-auto">
          {props.user && props.user.type === 'kita' && props.user.kita ? (
            ...
            <>
              <Nav.Link as={Link} to={`/parents/${props.user._id}/edit`}>Edit Profile</Nav.Link>
              {/* <Nav.Link as={Link} to="/parents/myProfile">Edit Profile</Nav.Link>  thursday new version one line up*/}
