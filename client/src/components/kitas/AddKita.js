...
<Form onSubmit={this.handleSubmit} >
  ...
  <Form.Group controlId="exampleForm.ControlSelect2">
    <Form.Label>Languages(s) used in Kita</Form.Label>
      ...
      >
        ...
        <option value="parent">Kurdish</option>
  ...
  <DropdownButton id="dropdown-item-button" title="Pedagogical focus">
    <Dropdown.Item as="button">Situational Approach</Dropdown.Item>
    <Dropdown.Item as="button">Montessori Pedagogy</Dropdown.Item>
